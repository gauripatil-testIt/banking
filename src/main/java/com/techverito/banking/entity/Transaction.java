...
public class Transaction {
    ...
    private Transaction(Builder b) {
        ...
        this.targetAccountNumber = b.targetAccountNumber;
    ...
    public static class Builder {
        ...
        public Builder targetAccountNumber(String v) { this.targetAccountNumber = v; return this; }
    ...
    public void setTargetAccountNumber(String v) { this.targetAccountNumber = v; }

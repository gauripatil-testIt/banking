...
class CustomerControllerTest {
    ...
    private CustomerRequest validRequest() {
        return new CustomerRequest(
                "John", "Doe", "john@example.com", "123", CustomerStatus.ACTIVE,
                "AB1234567", "PASSPORT", java.time.LocalDate.of(1990, 1, 1)
        );
    }

    private CustomerResponse response(Long id) {
        return new CustomerResponse(
                id, "John", "Doe", "john@example.com", "123", CustomerStatus.ACTIVE,
                "AB1234567", "PASSPORT", java.time.LocalDate.of(1990, 1, 1)
        );
    }
    ...
    @Test
    void POST_customers_missingKyc_returns400() throws Exception {
        CustomerRequest invalid = new CustomerRequest("John", "Doe", "john@example.com", "123", CustomerStatus.ACTIVE,
                "", "", null);
